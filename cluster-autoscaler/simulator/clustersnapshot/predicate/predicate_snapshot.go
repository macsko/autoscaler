...
func NewPredicateSnapshot(snapshotStore clustersnapshot.ClusterSnapshotStore, fwHandle *framework.Handle, parallelism int, draEnabled bool) *PredicateSnapshot {
